...
func (a *Client) GetProvisioningV1Products(params *GetProvisioningV1ProductsParams, opts ...ClientOption) (*GetProvisioningV1ProductsOK, error) {
	...
	if params == nil {
		params = NewGetProvisioningV1ProductsParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "GetProvisioningV1Products",
		Method:             "GET",
		PathPattern:        "/provisioning/v1/products",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http"},
		Params:             params,
		Reader:             &GetProvisioningV1ProductsReader{formats: a.formats},
	...
	success, ok := result.(*GetProvisioningV1ProductsOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for GetProvisioningV1Products: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
