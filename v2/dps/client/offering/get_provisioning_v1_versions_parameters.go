...
// NewGetProvisioningV1VersionsParams creates a new GetProvisioningV1VersionsParams object,
...
func NewGetProvisioningV1VersionsParams() *GetProvisioningV1VersionsParams {
	return &GetProvisioningV1VersionsParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewGetProvisioningV1VersionsParamsWithTimeout creates a new GetProvisioningV1VersionsParams object
...
// NewGetProvisioningV1VersionsParamsWithContext creates a new GetProvisioningV1VersionsParams object
...
// NewGetProvisioningV1VersionsParamsWithHTTPClient creates a new GetProvisioningV1VersionsParams object
...
/* GetProvisioningV1VersionsParams contains all the parameters to send to the API endpoint
   for the get provisioning v1 versions operation.

   Typically these are written to a http.Request.
*/
type GetProvisioningV1VersionsParams struct {
...
func (o *GetProvisioningV1VersionsParams) SetDefaults() {
	...
	val := GetProvisioningV1VersionsParams{
...
func (o *GetProvisioningV1VersionsParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.Topology != nil {
		...
		// query param topology
		var qrTopology string

		if o.Topology != nil {
			qrTopology = *o.Topology
		}
		qTopology := qrTopology
		if qTopology != "" {

			if err := r.SetQueryParam("topology", qTopology); err != nil {
				return err
			}
		}
	}
