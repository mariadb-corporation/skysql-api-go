...
func (m *V1CreateClusterRequest) validateApplications(formats strfmt.Registry) error {
...
func (m *V1CreateClusterRequest) contextValidateApplications(ctx context.Context, formats strfmt.Registry) error {
