...
func (a *Client) GetNotificationsV1SubscribersSubscriberIDNotifications(params *GetNotificationsV1SubscribersSubscriberIDNotificationsParams, opts ...ClientOption) (*GetNotificationsV1SubscribersSubscriberIDNotificationsOK, error) {
	...
	if params == nil {
		params = NewGetNotificationsV1SubscribersSubscriberIDNotificationsParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "GetNotificationsV1SubscribersSubscriberIDNotifications",
		Method:             "GET",
		PathPattern:        "/notifications/v1/subscribers/{subscriber_id}/notifications",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http"},
		Params:             params,
		Reader:             &GetNotificationsV1SubscribersSubscriberIDNotificationsReader{formats: a.formats},
	...
	success, ok := result.(*GetNotificationsV1SubscribersSubscriberIDNotificationsOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for GetNotificationsV1SubscribersSubscriberIDNotifications: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
