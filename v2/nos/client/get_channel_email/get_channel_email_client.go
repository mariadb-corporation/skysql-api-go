...
func (a *Client) GetNotificationsV1ChannelsEmailsChannelID(params *GetNotificationsV1ChannelsEmailsChannelIDParams, opts ...ClientOption) (*GetNotificationsV1ChannelsEmailsChannelIDOK, error) {
	...
	if params == nil {
		params = NewGetNotificationsV1ChannelsEmailsChannelIDParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "GetNotificationsV1ChannelsEmailsChannelID",
		Method:             "GET",
		...
		Schemes:            []string{"http"},
		Params:             params,
		Reader:             &GetNotificationsV1ChannelsEmailsChannelIDReader{formats: a.formats},
	...
	success, ok := result.(*GetNotificationsV1ChannelsEmailsChannelIDOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for GetNotificationsV1ChannelsEmailsChannelID: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
