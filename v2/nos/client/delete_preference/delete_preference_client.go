...
func (a *Client) DeleteNotificationsV1PreferencesPreferenceID(params *DeleteNotificationsV1PreferencesPreferenceIDParams, opts ...ClientOption) (*DeleteNotificationsV1PreferencesPreferenceIDOK, error) {
	...
	if params == nil {
		params = NewDeleteNotificationsV1PreferencesPreferenceIDParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "DeleteNotificationsV1PreferencesPreferenceID",
		Method:             "DELETE",
		PathPattern:        "/notifications/v1/preferences/{preference_id}",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http"},
		Params:             params,
		Reader:             &DeleteNotificationsV1PreferencesPreferenceIDReader{formats: a.formats},
	...
	success, ok := result.(*DeleteNotificationsV1PreferencesPreferenceIDOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for DeleteNotificationsV1PreferencesPreferenceID: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
